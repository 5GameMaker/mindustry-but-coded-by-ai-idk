...
pub use type_io::{
    ...
    write_world_label_sync, AbilityWire, BuildPlanWire, BuildingRef, BulletSyncWire, ContentRef,
    DecalSyncWire, EffectStateSyncWire, EntityRef, FireSyncWire, MountWire, Point2, PuddleSyncWire,
    TeamId, TypeValue, UnitRef, UnitSyncContainer, UnitSyncWire, Vec2, WeatherStateSyncWire,
    WorldLabelSyncWire,
};
pub use versions::{
