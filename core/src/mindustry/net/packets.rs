...
use crate::mindustry::io::type_io::{
    ...
    read_effect_id, read_i32, read_i64, read_int_seq, read_kick, read_object_safe,
    ...
    write_i64, write_int_seq, write_kick, write_object, write_objective_marker_json,
...
pub const REGISTERED_PACKET_MANIFEST: [PacketManifestEntry; 59] = [
...
pub const PACKET_MANIFEST: [PacketManifestEntry; 63] = [
