...
use crate::mindustry::io::type_io::{
    ...
    read_effect_id, read_i32, read_i64, read_kick, read_object_safe, read_objective_marker_json,
    read_plans_queue, read_string, read_team, read_tile_pos, read_u32, read_u8, read_unit_ref,
    write_block, write_bullet_type_id, write_bytes, write_client_plans, write_color,
    write_content_id, write_effect_id, write_i32, write_i64, write_kick, write_object,
    write_objective_marker_json, write_plans_queue_net, write_string, write_team, write_tile_pos,
    write_u32, write_unit_ref, BuildPlanWire, RgbaColor, TeamId, TypeValue, UnitRef,
};
...
pub const REGISTERED_PACKET_MANIFEST: [PacketManifestEntry; 54] = [
...
pub const PACKET_MANIFEST: [PacketManifestEntry; 58] = [
