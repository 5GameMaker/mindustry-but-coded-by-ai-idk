...
use crate::mindustry::io::type_io::{
    read_block, read_bytes, read_client_plans, read_i32, read_i64, read_kick, read_plans_queue,
    read_string, read_tile_pos, read_u32, read_u8, write_block, write_bytes, write_client_plans,
    write_i32, write_i64, write_kick, write_plans_queue_net, write_string, write_tile_pos,
    write_u32, BuildPlanWire,
};
...
pub const REGISTERED_PACKET_MANIFEST: [PacketManifestEntry; 46] = [
...
pub const PACKET_MANIFEST: [PacketManifestEntry; 50] = [
