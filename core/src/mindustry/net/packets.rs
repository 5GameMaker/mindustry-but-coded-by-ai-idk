...
pub const KICK_CALL_PACKET_MANIFEST: PacketManifestEntry = PacketManifestEntry {
    ...
    notes: "Generated by Call.registerPackets(); string kick reason variant.",
};
...
pub const REGISTERED_PACKET_MANIFEST: [PacketManifestEntry; 26] = [
...
pub const PACKET_MANIFEST: [PacketManifestEntry; 30] = [
