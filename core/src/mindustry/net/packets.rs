...
use crate::mindustry::io::type_io::{
    read_bytes, read_client_plans, read_i32, read_i64, read_kick, read_string, read_u32, read_u8,
    write_bytes, write_client_plans, write_i32, write_i64, write_kick, write_string, write_u32,
    BuildPlanWire,
};
...
pub const REGISTERED_PACKET_MANIFEST: [PacketManifestEntry; 45] = [
...
pub const PACKET_MANIFEST: [PacketManifestEntry; 49] = [
