...
- 仍未完成：Java 共享 `ItemModule` 引用的真正内存级等价、真实 `StorageBlock.incinerateEffect(...)` 视觉效果、net server/client 条件差异、core placement/upgrade 全流程、team core registry、完整 UI/renderer 行为。
