...
- 仍未完成：Java 共享 `ItemModule` 引用的真正内存级等价、`coreIncinerates/incinerateNonBuildable` 焚毁分支、真实 incinerate effect、core placement/upgrade 全流程、team core registry、完整 UI/renderer 行为。
